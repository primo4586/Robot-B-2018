...
public class ArcadeDrive extends Command {
    ...
    {
       	this.speed = SmartDashboard.getNumber("Driving direction", 1)*((this.oi.joystickDriver.getRawAxis(1) * SmartDashboard.getNumber("Max speed",0))+((this.oi.joystickDriver.getRawAxis(1))/Math.abs(this.oi.joystickDriver.getRawAxis(1)))*(oi.joystickDriver.getRawAxis(3)*0.3-oi.joystickDriver.getRawAxis(2)*0.3));
       	this.rotation = SmartDashboard.getNumber("Driving direction", 1)*(this.oi.joystickDriver.getRawAxis(4))*SmartDashboard.getNumber("Max Rotation Speed", 0.5);
